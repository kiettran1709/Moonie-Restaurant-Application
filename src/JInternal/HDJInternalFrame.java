...
public class HDJInternalFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btDSHD = new javax.swing.JButton();
        ...
        btDSHD.setText("Danh sách hóa đơn trong ngày");
        btDSHD.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        btDSHD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btDSHDActionPerformed(evt);
            }
        });
        jPanel1.add(btDSHD, new org.netbeans.lib.awtextra.AbsoluteConstraints(873, 560, 170, 30));
...
//         Xuất hóa đơn
    ...
    private void btDSHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDSHDActionPerformed
        DSHD hd = new DSHD();
        hd.setVisible(true);
    }//GEN-LAST:event_btDSHDActionPerformed
...
//             Đọc dữ liệu về Show lên bảng sản phầm
    ...
    private javax.swing.JButton btDSHD;
